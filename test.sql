...
create or replace temp table range_query 
as 
(
...
-- leaky_tire
create or replace temp table leaky_tire as (
select 
...
-- normal_tire
create or replace temp table normal_tire as 
 (
select 
TIMESTAMP_SECONDS(id) as time_s,
...
--one_sample_tire
create or replace temp table one_sample_tire as
(
